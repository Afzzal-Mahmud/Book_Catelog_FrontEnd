...
function Wishlist({allFavouriteBookList}) {
  return (
  ...
  <div className="container mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
    <div className="mx-auto max-w-3xl bg-white rounded-lg shadow-md p-6">
      <header className="text-center mb-8">
        <h1 className="text-xl font-bold text-gray-900 sm:text-3xl">Your Wishlist</h1><MdFavorite className='text-center' size={25}/>
        <p className='text-xl mt-2 dark:text-gray-800'>click any of the above book heart button to add to favorites and click the image to see more details and make a review</p>
      </header>

      {allFavouriteBookList.map((singleBook, index) => (
        <section key={index} className="md:bg-gray-100">
          <div className="container bg-gray-100 mx-auto px-2 pb-4 sm:px-6 sm:py-12 lg:px-8">
            <div className="mx-auto max-w-3xl bg-white rounded-lg shadow-md p-1 md:p[2rem] sm:px-6">
              <header className="text-center mb-8">
                <h1 className="text-base md:text-xl font-bold text-gray-900 sm:text-2xl">{singleBook?.title}</h1>
              </header>
              ...
              <ul className="space-y-4">
                <li className="flex flex-col sm:flex-row items-center mb-3 sm:gap-4">
                  ...
                  <div className="flex-1 mt-4 sm:mt-0">
                    <h3 className="text-base font-semibold text-gray-900">{singleBook?.author}</h3>
